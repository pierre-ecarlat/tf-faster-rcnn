...
class foodinc_reduced(imdb):
  def __init__(self, image_set, year, devkit_path=None):
    ...
    assert os.path.exists(self._devkit_path), \
      'Foodinc_reduced path does not exist: {}'.format(self._devkit_path)
  ...
  def _write_foodinc_reduced_results_file(self, all_boxes):
    for cls_ind, cls in enumerate(self.classes):
      if cls == '__background__':
        continue
      print('Writing {} Foodinc_reduced results file, ID: {}'.format(cls, cls_ind))
...
if __name__ == '__main__':
  ...
  d = foodinc_reduced('trainval', '2017')
  res = d.roidb
